...
title nigger vea fucking hell spoofer chair niggers free shit
Set mycmdWidth=75
Set mycmdHeight=40
...
echo %ESC%[44m%ESC%[92mhttps://dsc.gg/veaa
echo %ESC%[44m%ESC%[92m------------------------ %ESC%[97m%ESC%[44m 
echo.
for /f "tokens=1,2,* delims=_ " %%A in ('"findstr /b /c:":menu_" "%~f0""') do echo.  %%B  %%C
set choice=
echo.&set /p choice= choice:  ||GOTO:EOF
...
cls
echo %ESC%[44m%ESC%[92mdsc.gg/veaa
